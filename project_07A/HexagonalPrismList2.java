...
public class HexagonalPrismList2 
{
   ...
   */   
   public HexagonalPrismList2 readFile(String fileNameIn) throws IOException {
      ...
      HexagonalPrism[] myList = new HexagonalPrism[10];
      numberOfHexagonalPrisms = 0;
      String label = "";
  ...
  /**  
   * Returns the HexagonalPrism object in the array with the smallest side.
   * 
   * @return the HexagonalPrism object with the smallest side, otherwise  
   * returns null.
   */
   public HexagonalPrism findHexagonalPrismWithSmallestSide()
   {
      ...
      if (list[0] != null)
      {
         for (int i = 0; i < numberOfHexagonalPrisms; i++) 
         {
            if (list[i].getSide() <= list[result].getSide())
            {
               result = i;
            }
         }
  ...
  /**  
   * Returns the HexagonalPrism object in the array with the largest side.
   * 
   * @return the HexagonalPrism object with the largest side, otherwise  
   * returns null.
   */   
  ...
  /**  
   * Returns the HexagonalPrism object in the array with the smallest height.
   * 
   * @return the HexagonalPrism object with the smallest height, otherwise  
   * returns null.
   */
   public HexagonalPrism findHexagonalPrismWithSmallestHeight()
   {
      ...
      if (list[0] != null)
      {
         for (int i = 0; i < numberOfHexagonalPrisms; i++) 
         {
            if (list[i].getHeight() <= list[result].getHeight())
            {
               result = i;
            }
         }
